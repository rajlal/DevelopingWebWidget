...
public class RatingHandler : IHttpHandler {
    public void ProcessRequest(HttpContext context)
    {
        ...
        string user_IPAddress = context.Request.ServerVariables["REMOTE_ADDR"];
        ...
        try
        {
            ...
            myda.openConnection();
            int resultId = myda.CreateNewSession(user_IPAddress, myid);
            if (resultId != 1)
            {
            ...
            {
                context.Response.WriteFile("images/ar-info.png");
            }
